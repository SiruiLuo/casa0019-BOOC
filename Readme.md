...
<div style="display: flex; justify-content: center; gap: 20px; align-items: center; flex-wrap: wrap;">
  ...
  <div style="text-align: center;">
    <img src="Images/color test.jpg" alt="4 Different Modes" height="400">
    <p><b>Pic.1:</b> color test for making a vintage paper <br> look for the gauge</p>
  </div>

  <div style="text-align: center;">
    <img src="Images/InsideBooc.jpg" alt="4 Different Modes" height="400">
    <p><b>Pic.2:</b> The gauge design features with the <br> metal ball, the E-ink and the Buttons</p>
  </div>
</div>
...
<div style="display: flex; justify-content: center; gap: 20px; align-items: center; flex-wrap: wrap;">
  <div style="text-align: center;">
    <img src="Images/laser cutting.jpg" alt="4 Different Modes" height="400">
    <p><b>Pic.3:</b>  Laser cutting The BoOc Marker design with the shape of a feather</p>
  </div>
</div>
...
<div style="display: flex; justify-content: center; gap: 20px; align-items: center; flex-wrap: wrap;">
  ...
  <div style="text-align: center;">
    <img src="Images/Schematic.png" alt="4 Different Modes" height="330">
    <p><b>Pic.4:</b> Schematic Diagram</p>
  </div>

  <div style="text-align: center;">
    <img src="Images/circuit.jpg" alt="4 Different Modes" height="330">
    <p><b>Pic.5:</b> The Circuit in BoOC</p>
  </div>
</div>
...
<div style="display: flex; justify-content: center; gap: 20px; align-items: center; flex-wrap: wrap;">
  ...
  <div style="text-align: center;">
    <img src="Images/Gimp_pic.png" alt="4 Different Modes" height="400">
    <p><b>Pic.6:</b> GIMP and Binary Picture Storage</p>
  </div>
</div>
...
<div style="display: flex; justify-content: center; gap: 20px; align-items: center; flex-wrap: wrap;">
  ...
  <div style="text-align: center;">
    <img src="Images/eink.jpg" alt="4 Different Modes" height="400">
    <p><b>Pic.7:</b> Index Page Design</p>
  </div>
</div>
